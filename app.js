...
// 自定义版权信息（简单的html字符串）
var mapAttr = 'Map data &copy; <a href="https://github.com/ListeningLTG/Leafletlearn">Github地址</a> contributors, '+
            ...
            if (count === length) {
                ...
                marker = L.marker(drawPoints[length - 1], { icon: typhoonIcon }).addTo(map)
                    .bindPopup("<b>" + typhoonTestData[0]['name'] +
                        "</b><br>" + land['info'] + "<br>" + land['landtime'] + "<br>经度：" + land['lng'] + "<br>纬度：" + land['lat'] + "<br>强度：" + land['strong'])
                    .openPopup();
            } else {
